...
<div class="mega-vgrid-wrap">
  ...
  <div class="mega-vgrid">
    ...
    <a href="/beast-60x40-tipper" class="mega-vi" onclick="closeDrawer()">
      <div class="mega-vi-img"><img src="/images/beast-60x40-tipper/beast-60x40-tipper-yellow.png" onerror="this.style.opacity='.1'" alt="Beast 60x40 Tipper"></div>
      <span class="mega-vn">Beast 60&times;40 Tipper</span>
    </a>
    <a href="/iv-cart" class="mega-vi" onclick="closeDrawer()">
      <div class="mega-vi-img"><img src="/images/iv-cart/red.png" onerror="this.style.opacity='.1'" alt="IV Cart"></div>
      <span class="mega-vn">IV Cart</span>
      <span class="cs-pill" style="font-size:8px;padding:2px 6px;margin:2px 0 0;gap:4px;"><span class="cs-dot" style="width:5px;height:5px;"></span>Soon</span>
    </a>
    <a href="/titan-windshield" class="mega-vi" onclick="closeDrawer()">
      <div class="mega-vi-img"><img src="/images/titan-windshield/crossside.jpeg" onerror="this.style.opacity='.1'" alt="Titan Windshield"></div>
      <span class="mega-vn">Titan Windshield</span>
    </a>
  </div>
</div>
</div>
    ...
    <div class="mega-vgrid-wrap">
      ...
      <div class="mega-vgrid">
        ...
        <a href="/titan-windshield" class="mega-vi" onclick="closeDrawer()">
          <div class="mega-vi-img"><img src="/images/titan-windshield/crossside.jpeg" onerror="this.style.opacity='.1'" alt="Titan Windshield"></div>
          <span class="mega-vn">Titan Windshield</span>
          <span class="mega-vp">From ₹2.48L</span>
        </a>
      ...
      <div class="footer-cols">
        <div class="f-col">
          ...
          <ul>
            ...
            <li><a href="/beast-60x40-tipper">Beast 60&times;40 Tipper</a></li>
          </ul>
        </div>
        <div class="f-col">
          ...
          <ul>
            ...
            <li><a href="/iv-cart">IV Cart</a></li>
            <li><a href="/titan-windshield">Titan Windshield</a></li>
          </ul>
        </div>
        <div class="f-col">
  ...
  <div class="popup-overlay" id="popup-overlay">
    <div class="popup-box">
      ...
      <input type="text" name="website" id="p-honeypot" style="display:none;position:absolute;left:-9999px;" tabindex="-1" autocomplete="off">
      <div id="p-error" style="display:none;color:#e52222;font-size:12px;margin-bottom:8px;font-family:'DM Sans',sans-serif;"></div>
        ...
        <form onsubmit="submitForm(event)">
          ...
          <div class="fg"><label>Interested In</label>
            <select id="enquiry-vehicle-select">
              ...
              <option>Beast 60x40 Tipper</option>
              <option>IV Cart</option>
              <option>Titan Windshield</option>
